...
This project demonstrates the creation and configuration of an AI agent in Azure AI Foundry, including:
...
✔️ Recommend appropriate medical specialties

✔️ Prevent undesired content through instructions

✔️ Automate email generation for scheduling
